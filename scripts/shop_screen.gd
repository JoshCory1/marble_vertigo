...
func _on_cube_button_pressed():
	AudioPlayer.play_sfx("bounce_sfx_1")
	if GameController.skins_unlocked[1] == false && GameController.coins >= 1:
...
func _on_puzzle_pressed():
	AudioPlayer.play_sfx("bounce_sfx_1")
	if GameController.skins_unlocked[3] == false && GameController.coins >= 1000:
...
func _on_infinty_pressed():
	AudioPlayer.play_sfx("bounce_sfx_1")
	if GameController.skins_unlocked[4] == false && GameController.coins >= 1:
...
func _on_circle_pressed():
	...
	if GameController.skins_unlocked[5] == false && GameController.coins >= 1:
...
func _on_star_pressed():
	...
	if GameController.skins_unlocked[6] == false && GameController.coins >= 1:
...
func _on_crystel_pressed():
	...
	if GameController.skins_unlocked[7] == false && GameController.coins >= 1:
